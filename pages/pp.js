    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-md-8 col-lg-9">
          <h1 className="text-center decor color">Privacy Policy</h1>

          <br />

          <p
            align="center"
            style="margin-bottom: 0.28cm; border-top: 1.50pt solid #00000a; border-bottom: 1.50pt solid #00000a; border-left: none; border-right: none; padding: 0.04cm 0cm; line-height: 108%"
          >
            <b>INTRODUCTION</b>
          </p>
          ...
          <p align="justify" style="margin-bottom: 0.28cm; line-height: 108%">
            ...
            <span style="background: #ffffff">
              the privacy rules established by the Canadian Radio-television and
              Telecommunications Commission (“CRTC”) and all other applicable
          ...
          <p align="justify" style="margin-bottom: 0.28cm; line-height: 108%">
            <span style="background: #ffffff">
              ...
              Protection of Personal Information. These ten principles are the
              following:
            </span>
          </p>
          <ol>
            ...
            <li>
              <p style="margin-bottom: 0.28cm; line-height: 108%">
                br /each of Security Safeguards
              </p>
            </li>
            <li>
              <p style="margin-bottom: 0.28cm; line-height: 108%">
          ...
          <p align="justify" style="margin-bottom: 0.28cm; line-height: 108%">
            ...
            profession and includes, without limitation, that individual’s:
          </p>
          <ul>
            <li>
              <p
                align="justify"
                style="margin-bottom: 0.28cm; line-height: 108%"
              >
                Name;
              </p>
            </li>
          ...
          <p align="justify" style="margin-bottom: 0.28cm; line-height: 108%">
            ...
            <span style="background: #ffffff">
              ...
              subscribes for, uses, has used, or applies to use KOS products
              and/or services; (c) corresponds with KOS; and/or (d) is a Web
              Site User;{" "}
            </span>
          </p>
          <p align="justify" style="margin-bottom: 0.28cm; line-height: 108%">
          ...
          <p align="justify" style="margin-bottom: 0.28cm; line-height: 108%">
            ...
            <span style="background: #ffffff">
              ...
              officers, directors, agents, suppliers, resellers and
              distributors;
            </span>
          </p>
          <p align="justify" style="margin-bottom: 0.28cm; line-height: 108%">
          ...
          <p align="justify" style="margin-bottom: 0cm; line-height: 108%">
          ...
          <p align="justify" style="margin-bottom: 0cm; line-height: 108%">
            <span style="background: #ffffff">1.1 </span>KOS has designated one
            or more persons within senior management who are responsible for
            ensuring that KOS complies with the Privacy Policy.
            <span style="background: #ffffff">
              The persons so designated have the title of “
            </span>
            <b>
              <span style="background: #ffffff">Privacy Officer</span>
            </b>
            <span style="background: #ffffff">”. </span>Other individuals within
            KOS may be delegated to act on behalf of the Privacy Officer(s) or
            to take responsibility for the day-to-day collection and processing
            of Personal Information. Questions regarding KOS’s collection, use
            or disclosure of Personal Information or any other matter relating
            to this Privacy Policy can be directed to the Privacy Officer(s) by
            using the following contact coordinates:
          </p>
          <p align="justify" style="margin-bottom: 0cm; line-height: 108%">
            <br />
          </p>
          ...
          <p
            align="justify"
            style="margin-left: 1.27cm; text-indent: 1.27cm; margin-bottom: 0cm; line-height: 108%"
          >
          ...
          <p align="justify" style="margin-bottom: 0cm; line-height: 108%">
            ...
            <span style="display: inline-block; border: none; padding: 0cm">
              ...
              control, including information that has been transferred to a
              third party for processing. KOS shall use means to provide an
              appropriate level of protection while information is being
          ...
          <p align="justify" style="margin-bottom: 0.28cm; line-height: 108%">
            ...
            <font size="2" style="font-size: 9pt"></font>Unless required by law,
            KOS shall not use or disclose for any new purpose Personal
            Information that has been collected without first identifying and
            documenting the new purpose and obtaining the consent of the
          ...
          <ol type="a">
            <li>
              <p
                align="justify"
                style="margin-bottom: 0.68cm; line-height: 108%"
              >
          ...
          <p align="justify" style="margin-bottom: 0cm; line-height: 108%">
            ...
            drive of a Web Site User’s computer. Cookies are used to collect
            information anonymously and track user patterns on the KOS Websites.
            For example, Cookies might help us determine whether Customer is a
            repeat or first-time visitor of a KOS Website. When visiting the KOS
            Websites, you will be prompted with a notice that explains our use
            of Cookies. The notice will also ask for your prior consent to
            receiving and using our cookies. Cookies will not be stored on your
            devices without your consent. You may withdraw your consent at any
            time. If you do not wish to consent to our Cookies, or if you
          ...
          <p align="justify" style="margin-bottom: 0cm; line-height: 108%">
            ...
            services or products; (2) when a Customer uses KOS services or
            products; (3) when an individual submits an application for
            employment with KOS; or (4) when an Employee accepts employment or
            benefits from KOS. Notwithstanding, KOS shall seek consent to use
            and disclose Personal Information at the same time it collects the
            information. However, KOS may seek consent to use and disclose
          ...
          <ol type="a">
            <li>
              ...
              >
                <span style="background: #ffffff">
                  ...
                  individual is a minor, seriously ill or mentally
                  incapacitated;
                </span>
              </p>
            </li>
            ...
            <li>
              <p
                ...
                style="margin-bottom: 0.28cm; line-height: 108%"
              >
                <span style="background: #ffffff">Where it is </span>necessary
            ...
            <li>
              ...
              >
                <span style="background: #ffffff">
                  Where it is to a lawyer representing KOS;
                </span>
              </p>
            </li>
            <li>
            ...
            <li>
              ...
              >
                <span style="background: #ffffff">
                  ...
                  has been notified of the br /each is made solely for the
                  purpose of (1) reducing the risk of harm to the individual
                  that could result from the br /each; or (2) mitigating that
                  harm.{" "}
                </span>
              </p>
            </li>
            ...
            <li>
              ...
              <ol type="i">
                <li>
                  <p
                    align="justify"
                    style="margin-bottom: 0cm; line-height: 108%"
                  >
          ...
          <p align="justify" style="margin-bottom: 0.28cm; line-height: 108%">
            ...
            which was disclosed in accordance with Section 3.5, without the
            knowledge or consent of the Customer or Employee if:
          </p>
          <ol type="a">
            <li>
              <p
              ...
              <ol type="i">
                <li>
                  ...
                  >
                    ...
                    disclosed before the Business Transaction was completed;
                  </p>
                </li>
                <li>
                  <p
          ...
          <p align="justify" style="margin-bottom: 0cm; line-height: 108%">
            ...
            above. KOS shall retain Personal Information only as long as
          ...
          <ol type="a">
            <li>
              <p style="margin-bottom: 0cm; line-height: 0.53cm; background: #ffffff">
                <span style="display: inline-block; border: none; padding: 0cm">
                  Another telecommunications services provider for the efficient
                  and effective provision of telecommunications services;
                </span>
              </p>
            </li>
            <li>
              <p style="margin-bottom: 0cm; line-height: 0.53cm; background: #ffffff">
                <span style="display: inline-block; border: none; padding: 0cm">
                  An entity involved in supplying the Customer with
            ...
            <li>
              <p style="margin-bottom: 0cm; line-height: 0.53cm; background: #ffffff">
                <span style="display: inline-block; border: none; padding: 0cm">
                  Another entity for the development, enhancement, marketing or
                  provision of any of the products or services of KOS;
                </span>
              </p>
            </li>
            <li>
              <p style="margin-bottom: 0cm; line-height: 0.53cm; background: #ffffff">
                <span style="display: inline-block; border: none; padding: 0cm">
                  An agent retained by KOS in connection with the collection of
            ...
            <li>
              <p style="margin-bottom: 0cm; line-height: 0.53cm; background: #ffffff">
                <span style="display: inline-block; border: none; padding: 0cm">
                  A person who, in the reasonable judgment of KOS, is seeking
                  the information as an agent of the Customer; and
                </span>
              </p>
            </li>
            <li>
              <p style="margin-bottom: 0cm; line-height: 0.53cm; background: #ffffff">
                <span style="display: inline-block; border: none; padding: 0cm">
                  A third party or parties, where the Customer consents to such
          ...
          <p style="margin-bottom: 0.28cm; line-height: 0.53cm; background: #ffffff">
            <span style="display: inline-block; border: none; padding: 0cm">
              5.4{" "}
            </span>
            In addition, KOS may disclose an Employee’s Personal Information to:
          </p>
          <ol type="a">
            <li>
              <p style="margin-bottom: 0cm; line-height: 0.53cm; background: #ffffff">
            ...
            <li>
              <p style="margin-bottom: 0cm; line-height: 0.53cm; background: #ffffff">
                An Employee’s prospective employer for the purpose of providing
                a reference; and
              </p>
            </li>
            <li>
              <p style="margin-bottom: 0cm; line-height: 0.53cm; background: #ffffff">
                <span style="display: inline-block; border: none; padding: 0cm">
                  A third party or parties, where the Employee consents to such
                  disclosure or the disclosure is required by law.
                </span>
              </p>
            </li>
          </ol>
          ...
          <p align="justify" style="margin-bottom: 0cm; line-height: 108%">
            ...
            <span style="background: #ffffff">
              ...
              and practices for information and records retention and
              destruction which apply to Personal Information that is no longer
              necessary or relevant for the identified purposes or required by
              law to be retained. Such information shall be destroyed, erased or
              made anonymous within a reasonable period of time after KOS no
              longer reasonably requires the Personal Information for legal or
              business purposes.
            </span>
          </p>
          <p align="justify" style="margin-bottom: 0.28cm; line-height: 108%">
          ...
          <p align="justify" style="margin-bottom: 0cm; line-height: 108%">
            ...
            for the purposes for which it was collected; and (2) minimize the
          ...
          <p
            align="justify"
            style="margin-left: 1.5cm; margin-bottom: 0.28cm; line-height: 108%"
          >
            <br />
            <br />
          </p>
          ...
          <p align="justify" style="margin-bottom: 0cm; line-height: 108%">
            ...
            reasonable opportunity to review the Personal Information in the
            individual’s file, subject to the limitations described in Section
            9.3, below. Personal Information shall be provided in understandable
            form within a reasonable time and at a minimal or no cost to the
            individual. Customers and Employees may identify any issues with the
          ...
          <p align="justify" style="margin-bottom: 0cm; line-height: 108%">
            ...
            party or could reasonably be expected to threaten the life or
            security of another individual. Also, KOS may not provide access to
            ...
            privilege, if the information was generated in the course of a
            formal dispute resolution process, or if the information was
            collected in relation to the investigation of a br /each of an
            agreement, or a contravention of federal, provincial or foreign laws
            and / or regulations. If access to Personal Information cannot be
          ...
          <p align="justify" style="margin-bottom: 0cm; line-height: 108%">
            ...
            of use, KOS will provide information about the purposes for which
            the Personal Information has been and is being used by the
            organization. In providing an account of disclosure, KOS shall
          ...
          <p align="justify" style="margin-bottom: 0cm; line-height: 108%">
            ...
            In accordance with the terms of this Privacy Policy KOS may transmit
          ...
          <p align="justify" style="margin-bottom: 0.28cm; line-height: 108%">
            ...
            Safeguards, KOS shall report directly to the Office of the Privacy
          ...
          <p align="justify" style="margin-bottom: 0.28cm; line-height: 108%">
            ...
            the organization’s control if it is reasonable in the circumstances
            to believe that the br /each creates a real risk of significant harm
            to the individual. The notification will allow the individual to
            understand the significance of the br /each and to take steps, if
          ...
          <p
            align="center"
            style="margin-bottom: 0.28cm; border-top: 1.50pt solid #00000a; border-bottom: 1.50pt solid #00000a; border-left: none; border-right: none; padding: 0.04cm 0cm; line-height: 108%; page-br /eak-before: always"
          >
          ...
          <p align="justify" style="margin-bottom: 0cm; line-height: 108%">
            ...
            if necessary, amending its policies and procedures. The complainant
          ...
          <p align="justify" style="margin-bottom: 0cm; line-height: 108%">
            ...
            with the Commissioner’s office. However, the Customer or Employee is
            encouraged to use KOS’ internal information and complaint procedures
            first.
          </p>
          <p style="margin-bottom: 0.28cm; line-height: 108%">
            <br />
