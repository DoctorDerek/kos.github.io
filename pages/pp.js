    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-md-8 col-lg-9">
          ...
          <ol>
            <li>
              <p style={undefined}>Accountability</p>
            </li>
            <li>
              <p style={undefined}>
            ...
            <li>
              <p style={undefined}>Accuracy of Personal Information</p>
            </li>
            <li>
              <p style={undefined}>Security safeguards</p>
            </li>
            <li>
              <p style={undefined}>
            ...
            <li>
              <p style={undefined}>br /each of Security Safeguards</p>
            </li>
            <li>
              <p style={undefined}>Challenging compliance</p>
            </li>
          </ol>
          <p align="justify" style={undefined}>
          ...
          <p align="justify" style={undefined}>
            <span style={undefined}>1.1 </span>KOS has designated one or more
            persons within senior management who are responsible for ensuring
            that KOS complies with the Privacy Policy.
            <span style={undefined}>
              The persons so designated have the title of “
            </span>
            <b>
              <span style={undefined}>Privacy Officer</span>
            </b>
            <span style={undefined}>”. </span>Other individuals within KOS may
            be delegated to act on behalf of the Privacy Officer(s) or to take
            responsibility for the day-to-day collection and processing of
            Personal Information. Questions regarding KOS’s collection, use or
            disclosure of Personal Information or any other matter relating to
            this Privacy Policy can be directed to the Privacy Officer(s) by
          ...
          <p align="justify" style={undefined}>
            ...
            <font size="2" style={undefined}></font>Unless required by law, KOS
            shall not use or disclose for any new purpose Personal Information
            that has been collected without first identifying and documenting
            the new purpose and obtaining the consent of the Customer or
            Employee.
          </p>
          <p align="justify" style={undefined}>
          ...
          <ol type="a">
            ...
            <li>
              <p align="justify" style={undefined}>
                <span style={undefined}>Where it is </span>necessary to assess,
            ...
            <li>
              <p align="justify" style={undefined}>
                <span style={undefined}>Where it is to collect a debt;</span>
              </p>
            </li>
            <li>
              <p align="justify" style={undefined}>
