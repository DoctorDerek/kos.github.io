      ...
      <div className="row">
        ...
        <div className="col-md-8 col-lg-9">
          ...
          <ol>
            ...
            <li>
              <p>Identifying purposes for collection of Personal Information</p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>Limiting collection of Personal Information</p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>Openness concerning policies and practices</p>
            </li>
            <li>
              <p>Customer and Employee access to Personal Information</p>
            </li>
            <li>
              <p>br /each of Security Safeguards</p>
            </li>
            <li>
          ...
          <p align="justify">
            ...
            <span>The persons so designated have the title of “</span>
            <b>
              <span>Privacy Officer</span>
            </b>
            <span>”. </span>Other individuals within KOS may be delegated to act
            on behalf of the Privacy Officer(s) or to take responsibility for
            the day-to-day collection and processing of Personal Information.
            Questions regarding KOS’s collection, use or disclosure of Personal
            Information or any other matter relating to this Privacy Policy can
          ...
          <ol type="a">
            ...
            <li>
              <p>
                <span>Credit grantors and reporting agencies;</span>
              </p>
            </li>
            <li>
              <p>
