        ...
        <div className="sm:w-1/3">
          <div className="pricing-block color2">
            ...
            <div className="pricing-block__bottom">
              ...
              <br />
              <span style={{ fontSize: 26, color: "#005395" }}>
                300 GB DATA TRANSFER PER MONTH
              </span>
              <br />
              <br />
              <h6 className="title2">CABLE 40</h6>
              <p style={{}}>
                For active families and multiple users. All the features with
                more speed and data.
              </p>
              <p>
                <span
        ...
        <div className="sm:w-1/3">
          <div className="pricing-block color1">
            ...
            <div className="pricing-block__bottom">
              ...
              <p style={{}}>
                For power users. Perfect for people who demand the most speed
                available.
              </p>
              <p>
                <span
