...
var accessibilityIconStr = (accessibilitySign === "classic") ? '/assets/images/accessibility_1.png' : './assets/images/access.png';
...
function prepMenu() {
    ...
    switch (lang) {
        case "he_IL":
            menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='" + accessibilityIconStr + "' alt='Accessibility Menu Icon' role='navigation' title='תפריט ՠגישות'/></button>";
            ...
            menuHTML += "<button class='accessibilityMenuButton alignRight' id='btnHighContrastOn' onclick='ToggleHighContrastMode(true);'><i class='fa fa-adjust' aria-hidden='true'></i>&nbsp;&nbsp;מצב ՠיגודיות גבוהה</button>";
            menuHTML += "<button class='accessibilityMenuButton alignRight' id='btnHighContrastOff' onclick='ToggleHighContrastMode(false);'><i class='fa fa-adjust' aria-hidden='true'></i>&nbsp;&nbsp;מצב ՠיגודיות רגילה</button>";
            ...
            menuHTML += "<button class='accessibilityMenuButton alignRight' id='btnGrayscaleOn' onclick='ToggleGrayscaleMode(true);'><i class='fa fa-barcode' aria-hidden='true'></i>&nbsp;&nbsp;מצב גווՠי אפור</button>";
        ...
        case "en_US":
            ...
            break;
        case "es_ES":
            menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='/assets/image/accessibility_1.png' alt='Icono del menú Accesibilidad' role='navigation' title='Menú accesibilidad'/></button>";
            menuHTML += "<div id='slideout_inner'>";
            ...
            break;
        case "pt_PT":
            menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='/assets/image/accessibility.png' alt='ícone do menu de acessibilidade' role='navigation' title='menu de acessibilidade'/></button>";
            menuHTML += "<div id='slideout_inner'>";
            menuHTML += "<ul class='ltr'>";
            menuHTML += "<button class='accessibilityMenuButton alignLeft' id='btnTextSizeOn' onclick='setTextSize(true);'><i class='fa fa-text-height' aria-hidden='true'></i>&nbsp;&nbsp;letra grande</button>";
            ...
            break;
        case "ja_JP":
            menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='/assets/image/accessibility.png' alt='アクセシビリティメニューアイコン' role='navigation' title='アクセシビリティメニュー'/></button>";
            menuHTML += "<div id='slideout_inner'>";
            menuHTML += "<ul class='ltr'>";
            ...
            break;
        case "it_IT":
            menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='/assets/image/accessibility.png' alt='Icona Accessibilit` Menu' role='navigation' title='Accessibilit` Menu'/></button>";
            menuHTML += "<div id='slideout_inner'>";
            menuHTML += "<ul class='ltr'>";
            ...
            menuHTML += "<button class='accessibilityMenuButton alignLeft' id='btnHighContrastOn' onclick='ToggleHighContrastMode(true);'><i class='fa fa-adjust' aria-hidden='true'></i>&nbsp;&nbsp;modalit` ad alto contrasto</button>";
            menuHTML += "<button class='accessibilityMenuButton alignLeft' id='btnHighContrastOff' onclick='ToggleHighContrastMode(false);'><i class='fa fa-adjust' aria-hidden='true'></i>&nbsp;&nbsp;modalit` di contrasto regolare</button>";
            ...
            menuHTML += "<button class='accessibilityMenuButton alignLeft' id='btnGrayscaleOn' onclick='ToggleGrayscaleMode(true);'><i class='fa fa-barcode' aria-hidden='true'></i>&nbsp;&nbsp;modalit` a colori in scala di grigi</button>";
            menuHTML += "<button class='accessibilityMenuButton alignLeft' id='btnGrayscaleOff' onclick='ToggleGrayscaleMode(false);'><i class='fa fa-barcode' aria-hidden='true'></i>&nbsp;&nbsp;modalit` colore normale</button>";
            ...
            break;
        case "fr_FR":
            menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='/assets/image/accessibility.png' alt='Accessibilité Menu icon' role='navigation' title='Accessibilité Menu'/></button>";
            menuHTML += "<div id='slideout_inner'>";
            menuHTML += "<ul class='ltr'>";
            ...
            break;
        case "de_DE":
            menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='/assets/image/accessibility.png' alt='Barrierefreiheit Menü Icon' role='navigation' title='Erreichbar Menü'/></button>";
            menuHTML += "<div id='slideout_inner'>";
            menuHTML += "<ul class='ltr'>";
            ...
            break;
              menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='/assets/image/accessibility.png' alt='辅助功能菜单图䠇' role='navigation' title='辅助菜单'/></button>";
      case "zh_CN":
            menuHTML += "<div id='slideout_inner'>";
            menuHTML += "<ul class='ltr'>";
    ...
    */
    ...
    var cssText = "<link href='/css/yellow-links.css' title='yellow' type='text/css' rel='stylesheet' disabled='true'/>";
    cssText += "<link href='/css/underline-links.css' title='underline' type='text/css' rel='stylesheet' disabled='true'/>";
    cssText += "<link href='/css/grayscale.css' title='grayscale' type='text/css' rel='stylesheet' disabled='true'/>";

    if (sourceMenu == "accessible+") {
        cssText += "<link href='/css/night.css' title='contrast' type='text/css' rel='stylesheet' disabled='true'/>";
        cssText += "<link href='/css/biggest.css' title='textsize' type='text/css' rel='stylesheet' disabled='true'/>";
    } else {
        cssText += "<link href='/css/high-contrast.css' title='contrast' type='text/css' rel='stylesheet' disabled='true'/>";
        cssText += "<link href='/css/bigger.css' title='textsize' type='text/css' rel='stylesheet' disabled='true'/>";
    }
